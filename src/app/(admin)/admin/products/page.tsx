        ...
        <div className="text-blue-800 text-xs leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-x-6">
            ...
            <div>
              ...
              <p className="text-blue-700">BI% of MRP per unit — every upline member earns this same fixed % independently. Accumulated and released by admin quarterly / half-yearly / yearly.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="border-t border-gray-100 pt-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  {mrpVal > 0 && piVal > 0 && (
                    <p className="text-xs text-green-600 mt-1">₹{(mrpVal * piVal / 100).toFixed(2)} / unit (seller)</p>
                  )}
                </div>
                <div>
                  ...
                  <div className="relative">
                    <input type="number" min="0" max="100" step="0.01" value={form.piUpline}
                      onChange={e => setForm({ ...form, piUpline: e.target.value })}
                      placeholder="5"
                      className="w-full px-2.5 py-1.5 pr-7 border border-green-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                    />
                    <span className="absolute right-2.5 top-1.5 text-xs text-gray-400">%</span>
                  </div>
                  {mrpVal > 0 && piUplineVal > 0 && (
